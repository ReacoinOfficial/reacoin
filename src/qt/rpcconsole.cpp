...
void RPCConsole::clear(bool clearHistory)
{
    ...
    ui->messagesWidget->document()->setDefaultStyleSheet(
        QString(
                ...
                "td.message { color: #181818; font-family: calibri; font-size: 14px; white-space:pre-wrap; } "
                "td.cmd-request { color: #1CABCA; font-family: calibri; font-size: 17px; } "
                "td.cmd-error { color: #FF104B; } "
                ".secwarning { color: #F34189; }"
                "b { color: #FFB21E; font-family: calibri; font-size: 13px;} "
