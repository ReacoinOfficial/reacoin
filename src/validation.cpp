...
#if defined(NDEBUG)
# error "Reacoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Reacoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s REAN additional fees, %d delta bytes\n",
...
bool CVerifyDB::VerifyDB(const CChainParams& chainparams, CCoinsView *coinsview, int nCheckLevel, int nCheckDepth)
{
    ...
    if (nCheckDepth <= 0)
        // Reacoin: suffices until year 10214. Didn't x4 value due to integer wrap around and upstream compatibility.
